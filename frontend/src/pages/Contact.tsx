...
const Contact = () => {
    ...
    return (
        <div className="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md mt-8">
            <h2 className="text-2xl font-bold mb-2 text-center text-gray-800 dark:text-gray-100">Contact Us</h2>
            <p className="mb-6 text-center text-gray-600 dark:text-gray-300">Have a question or want to get in touch? Fill out the form below and we'll get back to you soon.</p>
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                ...
                <textarea name="message" required placeholder="Your Message" className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" rows={5} />
                ...
                {success && <p className="text-green-600 dark:text-green-400 text-center">Message sent! Redirecting...</p>}
                {error && <p className="text-red-600 dark:text-red-400 text-center">Failed to send message. Please try again.</p>}
            </form>
        </div>
    );
};
